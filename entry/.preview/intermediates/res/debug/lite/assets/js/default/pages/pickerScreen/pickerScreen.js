...
module.exports = function (vm) { var _vm = vm || this; return _c('stack', {'staticClass' : ["stack"]} , [_c('image', {'attrs' : {'src' : "/common/images/background.png"},'staticClass' : ["background"]} ),_c('div', {'staticClass' : ["container"],'onBubbleEvents' : {'swipe' : _vm.touchMove}} , [_c('text', {'attrs' : {'value' : "国家选择"},'staticClass' : ["title"],'staticStyle' : {'color' : 16711680}, } ),_c('picker-view', {'attrs' : {'type' : "text",'range' : function () {return _vm.country},'selected' : 1},'staticClass' : ["pickerView"]} ),_c('text', {'attrs' : {'value' : "时间选择"},'staticClass' : ["title"],'staticStyle' : {'color' : 16711680}, } ),_c('picker-view', {'attrs' : {'type' : "time",'selected' : "01:00"},'staticClass' : ["pickerViewTime"]} )] )] ) }
...
var _default = {
  data: {
    country: ["China", "Pakistan", "Saudi Arabia", "UAE", "America", "Canada"]
  },
